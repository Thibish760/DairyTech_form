      ...
      <div className="max-w-[1463px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="flex flex-col gap-6">
            <h2 className="[font-family:'Mochiy_Pop_P_One',Helvetica] font-normal text-white text-[25.4px] tracking-[0] leading-[normal]">
              AZHIZEN SOLUTION
            </h2>
            <p className="[font-family:'Mochiy_Pop_P_One',Helvetica] font-normal text-white text-[13.2px] tracking-[0] leading-[normal] max-w-[271px]">
              Easemilker Is An Automated Smart Milking System That Ensures
              Hygienic, Efficient, And Stress-free Milking For Cows.
            </p>
            <img
              className="w-[260px] h-7"
            ...
            <nav className="flex flex-col gap-4">
              {quickLinks.map((link, index) => (
                <a
                  ...
                  href="#"
                  className="[font-family:'Mochiy_Pop_P_One',Helvetica] font-normal text-[#ddd3ba] text-[13.2px] tracking-[0] leading-[normal] hover:text-white transition-colors"
                >
                  {link.label}
                </a>
              ))}
              ...
              {contactInfo.map((contact, index) => (
                ...
                >
                  <img
                    ...
                    src={contact.icon}
                  />
                  <span className="[font-family:'Mochiy_Pop_P_One',Helvetica] font-normal text-[#ddd3ba] text-[13.2px] tracking-[0] leading-[normal]">
                    {contact.text}
                  </span>
                </div>
              ))}
